"""
TIRP Pipeline - Mortality
Run: python pipeline_mortality.py
Config: config_mortality.json
"""
...
_CONFIG_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "config_mortality.json")
