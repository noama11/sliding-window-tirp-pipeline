...
Requires Python 3.8+ and nothing else. Verify the folder with
`python check_bundle.py --run`.
...
| Check | Result |
|---|---|
| `check_bundle.py` — stdlib-only, text-only, no subprocess/socket/urllib/ctypes | pass |
